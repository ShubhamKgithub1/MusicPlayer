...
const Explore = () => {
  ...
  return (
    <div className="flex flex-col gap-4 dark:bg-black/40 backdrop-blur-lg lg:bg-white/20 lg:max-h-full lg:h-max w-full p-4 lg:rounded-3xl lg:border lg:border-white/10 animate-fade-in shadow-md">
