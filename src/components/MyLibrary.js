...
const MyLibrary = () => {
  ...
  return (
    <div className="flex flex-col lg:dark:bg-black/40  lg:bg-white/20 lg:rounded-3xl p-4 lg:p-6 lg:backdrop-blur-lg h-full overflow-hidden text-white">
      <h1 className="font-semibold text-xl lg:text-2xl text-glow">User Library</h1>
