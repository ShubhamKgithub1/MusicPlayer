...
const handleTrackClick =(trackId) => {
    ...
    return (
        <div className="relative group flex items-center gap-3 p-2 rounded-lg transition-all duration-300 cursor-pointer active:scale-95" onClick={()=>handleTrackClick(track?.id)}>
