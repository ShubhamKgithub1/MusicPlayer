...
const Home = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:h-full sm:gap-4 md:dark:gap-0 w-full md:dark:text-textPrimary overflow-y-auto md:dark:bg-black/40 md:dark:backdrop-blur-lg p-2 lg:p-0 lg:dark:p-2 rounded-3xl transition-all duration-300 text-white">
