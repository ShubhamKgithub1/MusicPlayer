...
const Home = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:h-full md:gap-3 xl:gap-4 md:dark:gap-0 w-full overflow-y-auto md:dark:bg-black/40 lg:dark:border-white/10 backdrop-blur-lg md:backdrop-blur-none md:dark:backdrop-blur-lg p-1 lg:p-0 lg:dark:p-2 lg:dark:rounded-3xl transition-all duration-200 text-white">
