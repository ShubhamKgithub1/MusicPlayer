...
const Home = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:h-full sm:gap-4 sm:dark:gap-0 w-full sm:dark:text-textPrimary overflow-y-auto sm:dark:bg-black/40 sm:dark:backdrop-blur-lg p-2 rounded-3xl transition-all duration-300 text-white">
      <div className="flex flex-col sm:w-[40%] gap-0 h-[80dvh] sm:h-full shadow-black/40 shadow-inner sm:shadow-xl p-2 sm:p-4 sm:dark:p-2 sm:dark:backdrop-blur-none border border-white/10 sm:border-none sm:dark:bg-transparent sm:bg-white/30 dark:bg-black/20 backdrop-blur-lg sm:border sm:border-white/20 rounded-md sm:rounded-3xl animate-fade-in-delay">
      ...
      <div className="sm:flex-1 sm:overflow-hidden gap-2 sm:gap-4 h-full w-full flex flex-col px-0 sm:dark:p-2 transition-all duration-200">
        ...
        <div className="sm:overflow-hidden flex flex-col gap-2 sm:flex-row sm:gap-4 flex-1">
          <div className="sm:w-1/2 flex flex-col backdrop-blur-lg shadow-black/40 shadow-inner dark:bg-black/20 p-2 rounded-lg border border-white/10 sm:dark:border-none sm:shadow-lg sm:bg-white/30 sm:backdrop-blur-lg sm:border sm:border-white/20 sm:rounded-xl hide-scrollbar animate-fade-in sm:p-2">
          ...
          <div className="sm:flex-1 sm:min-w-0 flex flex-col shadow-black/40 shadow-inner sm:dark:border-none sm:shadow-lg p-2 dark:bg-black/20 backdrop-blur-lg sm:bg-white/30 sm:backdrop-blur-lg sm:border sm:border-white/20 sm:rounded-xl animate-fade-in sm:p-2 rounded-lg overflow-hidden border border-white/10">
