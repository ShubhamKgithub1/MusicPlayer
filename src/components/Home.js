...
const Home = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:h-full md:gap-4 md:dark:gap-0 w-full md:dark:text-textPrimary overflow-y-auto md:dark:bg-black/40 lg:dark:border lg:dark:border-white/10 md:dark:backdrop-blur-lg p-1 lg:p-0 lg:dark:p-2 lg:rounded-3xl transition-all duration-300 text-white">
