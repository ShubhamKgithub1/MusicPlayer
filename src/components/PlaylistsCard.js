const PlaylistsCard = ({playlist, setSelectedPlaylistId})=>{
    ...
    if(!playlist) return;
    return (
        <div className="relative z-40 snap-start flex-[0_0_25%] sm:flex-[0_0_20%] md:flex-[0_0_15%] xl:flex-[0_0_12%] 2xl:flex-[0_0_10%] hover:scale-[0.90] w-full h-full flex flex-col bg-white/20 overflow-hidden rounded-lg hover:bg-black/20 cursor-pointer transition-all duration-300 animate-fade-in"
