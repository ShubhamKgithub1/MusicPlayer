...
const CreatePlaylistModal = ({ userId }) => {
  ...
  return (
    <div className="fixed text-white inset-0 backdrop-blur-lg flex items-center justify-center z-[99] animate-fade-in">
      <div className="bg-black/40 backdrop-blur-lg rounded-lg p-6 w-96 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          onChange={(e) => setPlaylistName(e.target.value)}
            className="w-full px-3 hover:text-white hover:placeholder-white focus:placeholder-white py-2 rounded-full bg-white text-black/70 dark:bg-black/40 dark:hover:bg-white/10 dark:focus:bg-white/20 dark:focus:shadow-black hover:bg-white/10 dark:hover:shadow-black/20 dark:text-white dark:placeholder-white/70 placeholder-gray-600 hover:shadow-black/10 hover:shadow-inner focus:bg-white/10 focus:shadow-inner focus:shadow-black font-medium backdrop-blur-md outline-none transition-all duration-300"
